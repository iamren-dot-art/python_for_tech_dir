# Python for Technical Directors (v2.0)
...
### Milestone 1: Python Mechanics (The Sandbox)
*Building the absolute bedrock. Syntax mapping for systems-thinking veterans.*
* **Module 1.1:** Environment & Git Protocol (Pristine `.venv`, aliases, and repo structure)
* **Module 1.2:** Primitives & Variables (Strings, Integers, Floats, Booleans)
* **Module 1.3:** Control Flow (If/Else logic, `while` loops, `for` loops)
* **Module 1.4:** Functions & Scope (Building reusable blocks, understanding memory space)
...
### Milestone 3: Object-Oriented Pipeline Tools & Basic Agents
...
### Milestone 6: TouchDesigner & Real-Time Logic
*Applying Python to interactive node networks.*
* **Module 6.1:** TD Python Basics (`op()`, `me`, `.par` access)
* **Module 6.2:** Callbacks & Execute DATs (Reacting to frame, chop, and panel events)
* **Module 6.3:** Dynamic Networks (Creating/destroying nodes via Python)
* **Module 6.4:** Building Custom UI (Connecting panel components via Python logic)

### Milestone 7: Hardware & External I/O (The Bridge)
...
4. **The Loop:**
    ...
    * **Trace:** Quizzes requiring exact output matching to build execution tracing discipline.
